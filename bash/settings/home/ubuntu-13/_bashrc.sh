...
# This will make sure that spelling mistakes such
# Example: ect instead of etc are ignored.
shopt -s cdspell

# auto corrects the case
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@ubuntu-13\[\033[00m\]:\[\033[01;34m\]\W\[\033[00m\]\$ '
else
    # The following was changed by Bijay
    # Before => PS1='${debian_chroot:+($debian_chroot)}\u@\h:\w\$ '
    # After => PS1='${debian_chroot:+($debian_chroot)}\u@\h:\$ '
    PS1='${debian_chroot:+($debian_chroot)}\u@ubuntu-13:\W\$ '
fi
unset color_prompt force_color_prompt

# Comment in the above and uncomment this below for a color prompt
# PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\h\[\033[00m\]:\[\033[01;34m\]\[\033[00m\]\$ '
